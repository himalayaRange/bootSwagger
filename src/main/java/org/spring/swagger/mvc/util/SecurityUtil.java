...
import org.spring.swagger.mvc.support.security.BASE64Encoder;
import org.spring.swagger.mvc.support.security.coder.DESCoder;
import org.spring.swagger.mvc.support.security.coder.HmacCoder;
import org.spring.swagger.mvc.support.security.coder.MDCoder;
import org.spring.swagger.mvc.support.security.coder.RSACoder;
import org.spring.swagger.mvc.support.security.coder.SHACoder;
public class SecurityUtil {
	...
	public static void main(String[] args) throws Exception {
		...
		String sign = signRSA("fmkwaefw@Jmfe", privateKey);
		System.out.println(sign);
		
		String encrypt = encryptRSAPrivate("fmkwaefw@Jmfe", privateKey);
